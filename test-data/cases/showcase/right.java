...
public final class Pricing {
    ...
    public Money subtotal(
        ...
        if (running.isNegative()) { return Money.ZERO; }
        return running;
    }
    ...
    public Money total(List<Line> lines, Rules rules, double rate) {
        Money net = subtotal(lines, rules);
        Money tax = net.times(rate);
        Money shipping = shippingFor(net);
        return net.plus(tax).plus(shipping);
    }
    ...
    // ---------------------------------------------------------------------------------
    public Money discountAll(Collection<Discount> discounts, Money money) {
    ...
    // ---------------------------------------------------------------------------------
    public Money shippingFor(final Money subtotal) {
    ...
    // ---------------------------------------------------------------------------------
    public Money currentRate(Money money) {
        return money.times(0.19);
    }
